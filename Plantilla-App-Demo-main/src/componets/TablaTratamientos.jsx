                        ...
                        <tr className="border-b hover:bg-gray-300 text-center" key={tratamiento._id}>
                            ...
                            <td className='py-2 text-center'>
                                {auth.rol === "veterinario" && (
                                    <>
                                        <MdPublishedWithChanges className="h-7 w-7 text-slate-800 cursor-pointer inline-block mr-2" onClick={() => { cambiarTratamientos(tratamiento._id) }} />

                                        <MdOutlineSecurityUpdateGood className="h-7 w-7 text-slate-800 cursor-pointer inline-block mr-2" onClick={handleModal} />

                                        <MdDeleteForever className="h-8 w-8 text-red-900 cursor-pointer inline-block" onClick={() => { eliminarTratamientos(tratamiento._id) }} />
                                    </>)}
